...
class Server {
 public:
  ...
  Status FunctionSetCode(const rocksdb::Slice &ns, const std::string &lib, const std::string &code) const;
  Status FunctionSetLib(const rocksdb::Slice &ns, const std::string &func, const std::string &lib) const;
